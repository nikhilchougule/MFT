...
public partial class MftStudentsContext : DbContext
{
    public MftStudentsContext()
    {
    }

    public MftStudentsContext(DbContextOptions<MftStudentsContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySQL("Server=localhost;Database=MFT_Students;Uid=root;Pwd=Pune2024$;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Aspnetuser>(entity =>
        {
            ...
            entity.Property(e => e.Json).HasMaxLength(900);
            ...
            entity.HasMany(d => d.Roles).WithMany(p => p.Users)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<string>("UserId").HasMaxLength(127);
                        j.IndexerProperty<string>("RoleId").HasMaxLength(127);
                    });
        });
